...
export const Logo: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2L2 7V9.09C2 14.21 6.34 19.04 12 20.5C17.66 19.04 22 14.21 22 9.09V7L12 2ZM12 18.48C7.5 17.14 4 12.87 4 9.09V8.19L12 4.41L20 8.19V9.09C20 12.87 16.5 17.14 12 18.48Z"/>
        <path d="M11 10H13V16H11V10ZM11 7H13V9H11V7Z"/>
    </svg>
);
...
export const AdjustmentsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6V4m0 16v-2m0-8v-2m0 12h.01M6 12H4m16 0h-2m-8-6H8m12 0h-2M6 18H4m16 0h-2m-8-6h.01M18 6l-2-2m0 12l2 2m-6-12L8 4m0 12l2 2" />
    </svg>
);
